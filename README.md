...
Install via the [overheid-plugins]([https://github.com/MinBZK/overheid-claude-plugins](https://github.com/developer-overheid-nl/skills-marketplace)) marketplace:
